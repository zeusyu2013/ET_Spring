namespace ET.Server
{
    ...
    public static class ActionHelper
    {
        ...
        public static Action Create(this TrapComponent self, int configId, Unit owner, Unit caster, ActionTriggerType type, bool autoAction = true, bool autoDestroy = true)
        {
