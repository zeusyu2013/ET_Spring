...
namespace ET.Server
{
    ...
    public static partial class SkillComponentSystem
    {
        ...
        public static int Cast(this SkillComponent self, int skillConfig, int level)
        {
            ...
            {
                return ErrorCode.ERR_SkillConfigNotFound;
            }
            ...
            {
                return ErrorCode.ERR_SkillConsumeNotEnough;
            }
        ...
        {
            List<Unit> units = new();
            int ret = self.GetParent<Unit>().GetComponent<SelectTargetComponent>().Check(skillConfig, level, ref units);
            if (ret != ErrorCode.ERR_Success)
            {
                return ret;
            }
            ...
            if (units.Count < 1)
            {
                return ErrorCode.ERR_SkillNotTarget;
            }
