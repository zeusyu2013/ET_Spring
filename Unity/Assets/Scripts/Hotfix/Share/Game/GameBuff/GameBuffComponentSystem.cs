...
namespace ET
{
    ...
    [FriendOfAttribute(typeof(ET.GameBuffComponent))]
    [FriendOfAttribute(typeof(ET.GameBuff))]
    public static partial class GameBuffComponentSystem
    {
        [EntitySystem]
        private static void Awake(this ET.GameBuffComponent self)
        {
        }

        [EntitySystem]
        private static void Destroy(this ET.GameBuffComponent self)
        {
        }

        [EntitySystem]
        private static void Deserialize(this ET.GameBuffComponent self)
        {
        ...
        [EntitySystem]
        private static void Update(this ET.GameBuffComponent self)
        {
        }
        ...
        private static void AddBuffComponent(this GameBuffComponent self, GameBuff buff)
        {
            ...
            switch (type)
            {
                ...
                case BuffType.BuffType_ContinueDamage:
                    buff.AddComponent<GameBuffCounter, int>(buff.Config.Parameters[0]);
                    break;
